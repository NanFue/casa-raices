 ...
 * @property FormBuilderField|null $prevParent Temporary property used after field is removed only
...
class FormBuilderField extends FormBuilderData {
	...
	public function fbForm() {
		...
		if($this->prevParent) return $this->prevParent->fbForm();
	 ...
	 * @return array Associative array indexed by field name
	 *
	 */
