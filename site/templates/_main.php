...
<div class="uk-position-absolute uk-position-top">
    <div uk-sticky="cls-active: uk-background-default; cls-inactive: uk-light uk-background-transparent">
        <div class="uk-container uk-container-expand">
            <div id="topnav" class=" ">
                <nav class="" uk-navbar>
                    <div class="uk-navbar-left">
                        <a class="uk-logo" href="">
                            <img src="site/templates/img/logo-black.png" loading="lazy" alt="">
                            <img class="uk-logo-inverse" src="site/templates/img/logo.png" loading="lazy" alt="">
                        </a>
                    </div>
